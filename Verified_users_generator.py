...
usepickleIDs = False # This is a 2-stage scrip, get all IDs (takes a few hours) and then get all handles (takes a few days). This option will allow it to skip collecting IDs and use the last saved copy. Usful if doing multiple runs to complete stage 2.
